...
export default function DashboardCipali() {
  ...
  const fetchSensorData = async () => {
    try {
      // Ganti '/api/sensor' dengan route API InfluxDB Anda nanti
  ...
  useEffect(() => {
    ...
    // Set interval untuk refresh data dari database setiap 10 detik
  ...
  return (
    <main className="min-h-screen bg-black text-white p-4 md:p-8 font-sans">
      ...
      {loading ? (
        <div className="text-center py-20 text-gray-500 animate-pulse">Menghubungkan ke Database InfluxDB...</div>
      ) : (
      ...
      <div className="bg-[#111] border border-red-900/30 rounded-3xl overflow-hidden shadow-2xl mt-10">
        ...
        <div 
          ...
          style={{ height: '300px', display: 'block', WebkitOverflowScrolling: 'touch' }}
        >
